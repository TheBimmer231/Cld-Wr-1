...
//Overrides of the things above//
#define ui_inventory "WEST,SOUTH"
#define ui_sstore1 "WEST+3,SOUTH"
#define ui_id "WEST,SOUTH+2"
#define ui_belt "WEST+4:16,SOUTH"
#define ui_back "WEST+6,SOUTH"
#define ui_rhand "WEST+7:24,SOUTH"
#define ui_lhand "WEST+9:8,SOUTH"
#define ui_c_rhand "WEST+8.10,SOUTH"
#define ui_c_lhand "WEST+9.35,SOUTH"
#define ui_swaphand1 "WEST+7:24,SOUTH+1"
#define ui_swaphand2 "WEST+9:8,SOUTH+1"
#define ui_storage1 "EAST-4,SOUTH"
#define ui_storage2 "EAST-3,SOUTH"
#define ui_dropbutton "EAST-1,SOUTH+1"
#define ui_drop_throw "EAST-1,SOUTH+1"
#define ui_acti "EAST-1,SOUTH"
#define ui_above_movement "EAST-2,SOUTH+1"
#define ui_above_intent "EAST, SOUTH+2"
#define ui_zonesel "EAST,SOUTH"
#define ui_gun_burst "EAST-2,SOUTH"
#define ui_gun_railtoggle "EAST-2,SOUTH"
#define ui_gun_eject "EAST-2,SOUTH"
#define ui_gun_attachment "EAST-2,SOUTH"
#define ui_gun_unique "EAST-2,SOUTH"


//#define ui_gun_burst "EAST-2,SOUTH"
//#define ui_gun_eject "EAST-2,SOUTH"
#define ui_toxin "EAST,SOUTH+6"
#define ui_fire "EAST,SOUTH+6"
#define ui_oxygen "EAST,SOUTH+6"
#define ui_pressure "EAST,SOUTH+6"
#define ui_health "EAST,SOUTH+4:1"
#define ui_internal "EAST,SOUTH+6"
#define ui_ammo "EAST,SOUTH+8"
#define ui_shoes "WEST+1,SOUTH"
#define ui_iclothing "WEST+1,SOUTH+1"
#define ui_oclothing "WEST+1,SOUTH+2"
#define ui_gloves "WEST+2,SOUTH+1"
#define ui_glasses "WEST+2,SOUTH+3"
#define ui_mask "WEST,SOUTH+3"
#define ui_wear_ear "WEST+2,SOUTH+2"
