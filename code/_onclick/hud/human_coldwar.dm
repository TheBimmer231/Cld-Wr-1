...
/datum/hud/human/New(mob/living/carbon/human/owner, ui_style='icons/mob/screen/White.dmi', ui_color = "#ffffff", ui_alpha = 255)
	...
	ui_style = 'icons/mob/hud_32x32.dmi'
	var/ui_style64 = 'icons/mob/hud_32x64.dmi'
	var/ui_style48 = 'icons/mob/hud_48x32.dmi'
	...
	using.screen_loc = "WEST+2,SOUTH"
	toggleable_inventory += using
	infodisplay += using

	using = new /obj/screen()
	using.icon = ui_style64
	using.icon_state = "side_1"
	using.screen_loc = "EAST,SOUTH+3"
	...
	using.icon = ui_style
	using.icon_state = "background"
	using.screen_loc = "WEST,SOUTH to EAST,SOUTH"
	using.layer = UNDER_HUD_LAYER
	infodisplay += using
